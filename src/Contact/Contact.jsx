                            ...
                            <form>
                                <div>
                                    <div className="form-floating my-3 w-75 mx-auto px-2">
                                        <input type="text" className="form-control form-border shadow" id="Phone" placeholder="Name" />
                                ...
                                <div>
                                    <div className="form-floating my-3 w-75 mx-auto px-2">
                                        <input type="email" className="form-control form-border shadow" id="Phone" placeholder="email" />
                                        <ul className="signintext mt-3 invalid-feedback">
                                ...
                                <div>
                                    <div className="form-floating my-3 w-75 mx-auto px-2">
                                        <input type="number" className="form-control form-border shadow" id="Phone" placeholder="Phone" />
                                        <ul className="signintext mt-3 invalid-feedback">
                                ...
                                <div>
                                    <div className="form-floating my-3 w-75 mx-auto px-2">
                                        <textarea placeholder='Message' className='textarea w-100 rounded-3 shadow' rows="10"></textarea>
                                    </div>
                                </div>
